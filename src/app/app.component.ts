...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [FormsModule, RouterLink, RouterOutlet, IGX_CARD_DIRECTIVES, IGX_DIALOG_DIRECTIVES, IGX_LIST_DIRECTIVES, IgxAvatarComponent, IgxButtonDirective, IgxCheckboxComponent, IgxIconButtonDirective, IgxIconComponent, IgxOverlayOutletDirective, IgxRippleDirective, IgxSwitchComponent, IgxToggleActionDirective, IgxToggleDirective],
...
export class AppComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    this.dashboardDataService.getNewTeamMembersListList().pipe(takeUntil(this.destroy$)).subscribe(data => this.dashboardDataNewTeamMembersList = data);
  }
